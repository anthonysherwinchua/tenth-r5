...
RSpec.describe Admin::UsersController, type: :routing do
  ...
  # it { expect(get: '/admin/users/1/activate').to route_to('admin/users#activate', id: '1') }
  # it { expect(patch: '/admin/users/1/activate').to route_to('admin/users#activate', id: '1') }
  # it { expect(get: '/admin/users/1/deactivate').to route_to('admin/users#deactivate', id: '1') }
  # it { expect(patch: '/admin/users/1/deactivate').to route_to('admin/users#deactivate', id: '1') }
